...
<head>
    ...
    <title>E-Gallery | Register</title>
...
<body>
    ...
    <section class="flex h-screen">
        <!-- form untuk melakukan proses register -->
        <form method="post" action="proses_register.php" class="basis-1/2">
            <div class="flex flex-col px-24 py-10">
                <div class="flex items-center gap-5 text-ascent mb-10">
                ...
                <div class="flex flex-col mb-10">
                    <span class="font-semibold text-3xl text-primary">Selamat Datang!</span>
                    <span class="text-secondary/70">Silahkan register akun anda terlebih dahulu</span>
                </div>
                <div class="flex flex-col max-w-xl gap-14">
                    ...
                    <div class="flex flex-col gap-5">
                        <button type="submit" class="font-semibold bg-ascent text-white py-2 rounded-lg transition-all hover:scale-105">Register</button>
                        <div class="w-full">
                        ...
                        <button type="button" onclick="window.location.href='login.php'" class="border border-ascent py-2 rounded-lg font-semibold text-ascent transition-all hover:scale-105 hover:bg-ascent hover:text-white">Login</button>
                    </div>
                </div>
            </div>
        </form>
